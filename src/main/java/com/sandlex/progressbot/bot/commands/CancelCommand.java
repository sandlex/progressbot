...
public class CancelCommand implements ExecutableCommand {
    ...
    public BotResponse execute(Message message) {
        interactionStateMachine.transition(message.getFrom().getId(), new StateWithEntity(InteractionStates.CANCELLATION_PROJECT, new Project()));
        return new BotResponse(
                "Alright, which project do you want to cancel?",
